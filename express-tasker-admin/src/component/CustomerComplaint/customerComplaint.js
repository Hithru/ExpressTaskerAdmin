...
class CustomerComplaints extends Component {
  ...
  async componentDidMount() {
    const complaintsArray = await Customer.getComplaints();
    const complaints = complaintsArray.data;
    this.setState({ complaints });
  }

  async handleResolved(complaint_id) {
    const complaint = await Customer.resolveComplaint(complaint_id);
    window.location = "/admin/customercomplaints";
  }
  render() {
